...
<?php 
    $about = array(
        'pt'=>array('Sobre mim',
                    'Ola! Aqui é o <i>Vitor</i> e eu sou um graduando segundanista em <i>Ciência da Computação</i> na <i>Universidade Estadual de Londrina</i>. Eu não tinha nenhuma experiência em ciência da computação quando eu iniciei meu curso e tambem não tinha certeza se aquela área era a certa pra mim. Acontece que era sim a minha área e eu vou adorar trabalhar com ela no futuro.',
                    'Eu venho explorando as terras do <i>desenvolvimento web full-stack</i> nos ultimos meses e tem sido muito interessante. Eu tambem vou aprender desenvolvimento mobile no futuro porque essa é outra subárea que eu me interesso bastante. A propósito, quase tudo na área de ciência da computação é interessante para mim. Eu simplesmente não consigo ver o tempo passar enquanto estou entendendo como toda a mágica por trás dos computadores funciona.',
