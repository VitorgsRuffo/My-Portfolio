...
<?php 
    $pwdBank = array(
        'pt'=>array('Descrição',
                    'Este projeto ainda esta sendo desenvolvido, e como pode-se ver não possui nenhuma estilização. Estou desenvolvendo-o apenas com o intuito de praticar e portanto ele não será posto online. Eu comecei a trabalhar nesse website em Fevereiro de 2020, um mês após começar a estudar desenvolvimento web.',
                    ...
                    'Este site é um projeto de código aberto que pode ser encontrado na minha página do <a href="https://github.com/VitorgsRuffo/PasswordBank" target="_blank">Github</a>.',
                    'Entre em contato'),
        'en'=>array('Description',
                    'This project is being developed yet, as you can see it doesn\'t have any styling. I\'m building this website only for training purposes thus it is not going to be deployed. I started to work on it back in February 2020 one month after starting to learn web development.',
